(function() {
  var cssPath, express, file, files, findFile, findit, fs, generateFile, getSections, haml, hamlify, jade, key, langs, link, menu, mkdirp, optimist, options, parser, parts, path, readme, sections, server, sources, writeFile, _, _i, _len;
